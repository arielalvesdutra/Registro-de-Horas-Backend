...
** obs1: no momento, ainda é preciso criar a base de dados manualmente com o conteúdo do arquivo database.sql. Tem uma issue aberta para implementar a funcionalidade de criar a base de dados.
